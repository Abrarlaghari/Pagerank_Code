function [W L T] = createMatricesBThometie( leagueData, startGameDay, lastGameDay, params )
    dataDir = 'data';
    ...
    for i = 1:size(allResults, 1)
        ...
        gdEnd = lastGameDay; %min(lastGameDay, gameDay+learnGameDays);
        ...
        if goals2 > goals1
          for gd = gdStart:gdEnd
            L{gd}(teamIx1, teamIx2) = 1 + L{gd}(teamIx1, teamIx2);
          end
        end
